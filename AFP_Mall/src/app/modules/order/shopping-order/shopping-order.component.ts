...
export class ShoppingOrderComponent implements OnInit, AfterViewInit {
  ...
  constructor(public appService: AppService, public modal: ModalService, private router: Router, private meta: Meta, private title: Title, public appJSInterfaceService: AppJSInterfaceService) {
